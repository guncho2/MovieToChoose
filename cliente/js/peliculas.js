    ...
    $.getJSON(servidor + "/generos",
        function(data) {
            for (let i = 0; i < data.generos.length; i++) {
                ...
                const opcion = $(".genero-select option[value='0']").clone();
...
function ControladorPeliculas() {
    ...
    this.buscarPeliculas = function(pagina, cantidad) {
            ...
            //solo se envia el parametro director si hay algun valor para filtrar por ese campo
            if (director) {
